/*----------------------------------------------------------------------------*/
/* Copyright 2015-2020,2022-2024 NXP                                          */
/*                                                                            */
...
/*
 * MK Code Addition
 * Board header file for nRF52840 driving PN5190
 * Author: andrew li
 * Date:   16 Jul 2024
 */
    ...
    defined(PHDRIVER_nRF52840_PNEV5190B_BOARD)
...
#define NXPBUILD__PHPAL_SLI15693_SW                         /**< PAL SLI 15693 Component is included. */
                           ...
                           /**< If FE HAL is PN722x, then exclude ISO18000p3m3 PAL, otherwise include as required. */
...
/*#define NXPBUILD__PH_CIDMANAGER_SW*/                          /**< CID Manager SW Component is included. */
    ...
    #define NXPBUILD__PH_KEYSTORE_SW                            /**< SW KeyStore Component is included. */
        ...
        #define NXPBUILD__PH_KEYSTORE_PN76XX                    /**< PN76XX KeyStore Component is included. */
        #define NXPBUILD__PH_KEYSTORE_PN76XX_NDA                /**< PN76XX NDA KeyStore Component is included. */
